...
/**
 * Retrieves a demo traveler profile by their unique ID.
 * @param {string} id - The demo user identifier.
 * @returns {Object|null} The demo user profile, or null if not found.
 */
...
/**
 * Checks if a user ID corresponds to a seeded demo account.
 * @param {string} id - The user identifier to verify.
 * @returns {boolean} True if it is a demo account, false otherwise.
 */
...
/**
 * Flattens and retrieves all community posts from demo profiles, sorted newest first.
 * @returns {Array} List of formatted community posts.
 */
